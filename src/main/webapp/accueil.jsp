...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #B22222;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link disabled" href="accueil.jsp" style="color:#FFFFFF;">Mes reservations</a>
            </li>
            <li class="nav-item">
        ...
        <table id="myTable">
            ...
            <%
                ...
                for (Map<String,Object> une:list
                    ...
                    out.print(" <td><a class='bouton' href=ServletAnnulerResM?date="+une.get("date") +
                            "&periode="+une.get("periode")+"&idU="+id+"&idM="+une.get("codeM")+"> Annuler</a></td></tr>");
